...
baa.write(language='zh', style='H1', content='This is the first Sheep site built with Sheep and atm it\'s horrible anyways https://github.com/AtlasL1/Sheep', size='29px', font='Roboto', colour='yellow')
baa.view_page()
